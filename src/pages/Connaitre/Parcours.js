    ...
    return (
        <div className="flex items-center bg-nude-50 flex-1 flex-col">
            <div className="flex flex-col items-center">
                <img src="/assets/illustrations/parcours.png" className="flex w-screen flex-row justify-center h-96 object-cover"/>
                <div className="bg-nude-50 h-10 -mt-5 flex items-center px-10">
                    <h1 className="text-brown-50 text-2xl">Mon parcours</h1>
                </div>
                <div className="flex w-full flex-col items-center max-w-6xl pb-28">
                    <div className="flex items-center bg-white w-full shadow-[0px_0px_10px_1px_#ECECEC] rounded-xl p-8 my-8 z-10 justify-between">
                        <img src="/assets/illustrations/parcours1.png" alt="univ" className=" w-64 object-contain mr-16" />
                        <p className="">
                    ...
                    <div className="flex items-center bg-white w-full shadow-[0px_0px_10px_1px_#ECECEC] rounded-xl p-8 my-8 z-10 justify-between">
                        ...
                        <img src="/assets/illustrations/parcours2.png" alt="univ" className="w-64 object-contain ml-16" />
                    </div>
                </div>
            </div>
        </div>
