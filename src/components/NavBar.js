    ...
    return (
        <div className="bg-brown-25 flex justify-between transition-all duration-500 ease-in-out">
            ...
            <div className="flex items-center">
                ...
                <div className="group flex justify-center cursor-pointer mr-11 transition-colors duration-200 ease-in-out">
                    ...
                    <div className="absolute hidden group-hover:block">
                        <div className="flex bg-white mt-9 rounded-md p-5">
                            <div>
