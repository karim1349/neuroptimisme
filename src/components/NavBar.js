        ...
        <div className="bg-brown-25 flex justify-between transition-all duration-500 ease-in-out z-50">
            ...
            <div className="flex items-center">
                ...
                <div className="group flex justify-center cursor-pointer mr-11 transition-colors duration-200 ease-in-out hover:text-brown-50">
                    ...
                    <div className="absolute hidden group-hover:block delay-100">
                ...
                <Link to="/a_propos"    className="cursor-pointer mr-11 transition-colors duration-200 ease-in-out hover:text-brown-50 z-50">À propos</Link>
                <div className="group flex justify-center cursor-pointer mr-11 transition-colors duration-200 ease-in-out hover:text-brown-50">
                ...
                <Link to="/tarifs"  className="cursor-pointer mr-11 transition-colors duration-200 ease-in-out hover:text-brown-50 z-50">Mes tarifs</Link>
            </div>
        </div>
    )
}
