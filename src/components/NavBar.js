...
const NavBar = () => {
    ...
    return (
        <div className="bg-brown-25 flex flex-col sm:flex-row justify-between transition-all duration-500 ease-in-out z-50">
            ...
            <div className={`sm:flex sm:flex-row sm:items-center overflow-hidden transition-all duration-300 ease-in-out pl-3 sm:pl-0
                ${isOpen ? 'max-h-[500px] opacity-100' : 'max-h-0 sm:max-h-[500px] opacity-0 sm:opacity-100'}`}>
